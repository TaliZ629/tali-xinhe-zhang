...
const ExperienceSection = () => (
  <section id="experience" className="px-[6%] md:px-[10%] py-24 bg-warm-white">
    <SectionHeader
      ...
      section="experience"
      labelExtra={<>For detailed experience information, please feel free to <a href="#contact" className="text-dusty-rose hover:text-terracotta underline underline-offset-2 transition-colors">get in touch</a>.</>}
    />
